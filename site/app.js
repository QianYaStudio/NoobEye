import { setupSensor } from './sensor.js?v=issue-018-20260924';
import { celebrateCompletion } from './celebration.js';
import {targetOutline,createOutlineMark} from './target-outlines.js?v=issue-018-20260924';
import { effect, setupAudio, setIssueMusic, startListening } from './audio.js?v=issue-018-20260924';
import { tr, labelOf, titleOf, introOf, clueOf, setupLanguage } from './i18n.js?v=issue-018-20260924';
import {setupProjectLinks} from './project.js';
import {setupSubscriptions} from './subscriptions.js?v=issue-018-20260924';
...
async function init(){
  ...
  try {
    const response=await fetch('./catalog.json?v=issue-018-20260924');if(!response.ok)throw new Error('Content unavailable');
